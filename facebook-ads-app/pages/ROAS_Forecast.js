        ...
        <div id="fullscreen">
          <div className="container">
            <div className="cost-inputs">
              <TextStyle>Average Order Value (£)</TextStyle>
              <input
                type="number"
                placeholder="405"
              ...
              ></input>
              <br></br>
              <TextStyle>Credit Card Fees (%)</TextStyle>
              <input
                type="number"
                placeholder="2.50"
                id="credit-card-fee"
              ></input>
              <br></br>
              <TextStyle>Merchant Processing Fees (%)</TextStyle>
              <input type="number" placeholder="2.50" id="merchant-fee"></input>
              <br></br>
              <TextStyle>Shipping Costs (£)</TextStyle>
              <input type="number" placeholder="5.00" id="shipping-fee"></input>
              <br></br>
              <TextStyle>Fulfilment Cost Per Unit (£)</TextStyle>
              <input
                type="number"
                placeholder="5.00"
                id="fulfilment-fee"
              ></input>
              <br></br>
              <TextStyle>Product Cost (singular) (£)</TextStyle>
            ...
            <div className="roas-forcast">
              <table className="roas-numbers">
                ...
                <th>
                  ...
                  <tr id="spend-1">300</tr>
                  <tr id="spend-2">350</tr>
                  <tr id="spend-3">400</tr>
                  <tr id="spend-4">450</tr>
                  <tr id="spend-5">500</tr>
                </th>
                <th>
                  <p id="roas-1">1</p>
